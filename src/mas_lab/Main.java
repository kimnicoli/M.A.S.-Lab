...
public class Main {
	...
	/**
	 * Capacit� massima per gli agenti Restaurant
	 */
	public static int MaxCapacity = 20;
	/**
	 * Capacit� minima per gli agenti Restaurant
	 */
	...
	/**
	 * Probabilit� di una valutazione irrazionale
	 */
	public static double ProbFuzzyEvaluation = 0.1;
	
	/**
	 * Probabilit� di scegliere in base alla miglior opinione del miglior amico
	 */
	public static double ProbChooseBFF = 	0.1;
	/**
	 * Probabilit� di scegliere il primo ristorante che risponde "libero"
	 */
